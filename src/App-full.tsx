            ...
            {galleryImages.map((image, index) => (
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-gray-950/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-4">
                  <a
                    href="https://instagram.com/illuminatitattoooc"
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              ...
              <div className="flex space-x-4">
                ...
                <a
                  href="https://facebook.com/illuminatitattoooc"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex-1 bg-blue-600 p-4 rounded-xl flex items-center justify-center space-x-2 hover:opacity-90 transition-opacity"
                >
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <div className="flex space-x-4 mt-4">
                <a href="https://instagram.com/illuminatitattoooc" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-pink-400 transition-colors">
                  <Camera className="w-5 h-5" />
                </a>
                <a href="https://facebook.com/illuminatitattoooc" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-400 transition-colors">
                  <Users className="w-5 h-5" />
                </a>
              </div>
            </div>
